...
def validate_windows_shortcuts():
    ...
    from legado.src.lib.shortcuts import APP_NAME
    from legado.src.lib.windows_shortcuts import (
...
def validate_linux_shortcuts():
    ...
    from legado.src.lib.shortcuts import APP_SLUG
...
def validate_macos_shortcuts():
    ...
    from legado.src.lib.shortcuts import APP_NAME, APP_SLUG
